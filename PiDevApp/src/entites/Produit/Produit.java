...
public class Produit {
    ...
    public Produit(int idProduit, String nomProduit, int quantiteProduit, Button bouton) {
        this.idProduit = idProduit;
        this.nomProduit = nomProduit;
        this.quantiteProduit = quantiteProduit;
        this.bouton = bouton;
    ...
    public Produit(int idProduit, String nomProduit, int quantiteProduit, double prixProduit, Button btSupp) {
          this.idProduit = idProduit;
        this.nomProduit = nomProduit;
        this.quantiteProduit = quantiteProduit;
        this.bouton = btSupp;
