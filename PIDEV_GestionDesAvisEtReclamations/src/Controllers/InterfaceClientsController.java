 ...
 */
public class InterfaceClientsController implements Initializable {
    ...
    private void openPageEnvoiReclamation(MouseEvent event) throws IOException {
        Parent homePageParent = FXMLLoader.load(getClass().getResource("/Views/InterfaceEnvoiDesReclamations.fxml"));
        Scene homePageScene = new Scene(homePageParent);
        Stage appStage =(Stage)((Node) event.getSource()).getScene().getWindow();
        appStage.setScene(homePageScene);
        appStage.show();
    ...
    @FXML
    private void openPageAjouterQuestion(MouseEvent event) {
    }
